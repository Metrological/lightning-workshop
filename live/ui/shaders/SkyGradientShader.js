export default class SkyGradientShader extends lng.shaders.WebGLDefaultShader {
    constructor(context) {
        super(context);
    ...
    setExtraAttribsInBuffer(operation) {
        ...
        for (let i = 0; i < length; i++) {
            ...
            let brx = operation.getElementWidth(i) / operation.getTextureWidth(i);
            let bry = operation.getElementHeight(i) / operation.getTextureHeight(i);
...
SkyGradientShader.vertexShaderSource = `
    #ifdef GL_ES
...
SkyGradientShader.fragmentShaderSource = `
    #ifdef GL_ES
    precision lowp float;
    #endif
    varying vec2 vTextureCoord;
